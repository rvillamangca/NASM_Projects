...
;
;       1.  for convenience we precalculated that there are 5,163 names inside the given names
;           file. the longest name is 11 characters long.
...
summation:
    ...
    imul    rdi, LEN_NAMES
    add     rdi, names_val
    add_byte_array rbx, rdi, LEN_NAMES
    mul     rbx
